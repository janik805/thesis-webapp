package com.awesome.thesis.rules;
...
/**
 * Regel, dass Aggregate nur ein Root haben dürfen.
 */
public class HaveExactlyOneAggregateRoot extends ArchCondition<Slice> {
  /**
   * Check, dass Aggregate nur ein Root haben dürfen.
   *
   * @param slice  Aggregat
   * @param events Events
   */
  ...
  // Konstruktion der Vollständigkeit halber
